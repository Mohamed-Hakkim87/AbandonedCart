...
{
    //customer
    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_1 = 'hikmadh_abandoned_cart/customers/enabled_1';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_2 = 'hikmadh_abandoned_cart/customers/enabled_2';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_3 = 'hikmadh_abandoned_cart/customers/enabled_3';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_4 = 'hikmadh_abandoned_cart/customers/enabled_4';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_1 = 'hikmadh_abandoned_cart/customers/send_after_1';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_2 = 'hikmadh_abandoned_cart/customers/send_after_2';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_3 = 'hikmadh_abandoned_cart/customers/send_after_3';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_4 = 'hikmadh_abandoned_cart/customers/send_after_4';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_1 = 'hikmadh_abandoned_cart/customers/template1';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_2 = 'hikmadh_abandoned_cart/customers/template2';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_3 = 'hikmadh_abandoned_cart/customers/template3';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_4 = 'hikmadh_abandoned_cart/customers/template4';

    //guest
    const XML_PATH_LOSTBASKET_GUEST_ENABLED_1 = 'hikmadh_abandoned_cart/guests/enabled_1';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_2 = 'hikmadh_abandoned_cart/guests/enabled_2';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_3 = 'hikmadh_abandoned_cart/guests/enabled_3';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_4 = 'hikmadh_abandoned_cart/guests/enabled_4';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_1 = 'hikmadh_abandoned_cart/guests/send_after_1';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_2 = 'hikmadh_abandoned_cart/guests/send_after_2';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_3 = 'hikmadh_abandoned_cart/guests/send_after_3';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_4 = 'hikmadh_abandoned_cart/guests/send_after_4';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_1 = 'hikmadh_abandoned_cart/guests/template1';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_2 = 'hikmadh_abandoned_cart/guests/template2';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_3 = 'hikmadh_abandoned_cart/guests/template3';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_4 = 'hikmadh_abandoned_cart/guests/template4';
    ...
    {
        $quoteUrl = $this->frameworkTemplate->getUrl('hikmadh_abandoned_cart/cart/index', ['quote'=>$quote->getId()]);
